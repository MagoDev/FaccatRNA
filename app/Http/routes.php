...
Route::get('trends/{id}', function($id)
{
    return Twitter::getTrendsPlace(array('id' => $id, 'format' => 'json'));
});

Route::get('search/{term}/{limit?}', function($term,$limit=null)
{
    $data = Twitter::getSearch(array('q' => $term, 'count' => ($limit) ? $limit : 20, 'format' => 'json'));
    return $data;
});

Route::get('user/{username}', function($username)
{
    return Twitter::getUserTimeline(array('screen_name' => $username, 'count' => 20, 'format' => 'json'));
});
